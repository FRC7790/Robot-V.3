...
public class OI {
  ...
  // button3 = new JoystickButton(3),
  // button4 = new JoystickButton(4),
  // button5 = new JoystickButton(5),
  // button6 = new JoystickButton(6),
  // button7 = new JoystickButton(7),
  // button8 = new JoystickButton(8);
